...
Item {
    ...
    property real contentPreferredHeight: {
        var h = mainContainer.implicitHeight + Style.marginL * 2
    ...
    onActiveFocusChanged: if (activeFocus) toolBarArea.forceActiveFocus()
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            // Content Box (Toolbar & Active Tool Content)
            NBox {
                id: contentBox
                Layout.fillWidth: true
                Layout.preferredHeight: contentLayout.implicitHeight + Style.margin2M
                ...
                ColumnLayout {
                    ...
                    Item {
                        id: toolBarArea
                        Layout.fillWidth: true
                        Layout.preferredHeight: toolsCol.height
                        focus: true
                    ...
                    // Recorder Active/Recording Status (Stop button)
                    Rectangle {
                        property bool _shown: root.viewedTool === "record" && root.isRecording && !root.isRunning
                        visible: _shown
                        ...
                        RowLayout {
                            ...
                            NText { text: pluginApi?.tr("record.stop"); color: recPanelStopBtn.containsMouse ? "white" : Color.mOnSurface; font.weight: Font.Bold; pointSize: Style.fontSizeS; Layout.alignment: Qt.AlignVCenter }
                        }
                    ...
                    // Converting Spinner
                    Rectangle {
                        property bool _shown: root.viewedTool === "record" && root.isConverting && !root.isRunning
                        visible: _shown
                        opacity: _shown ? 1.0 : 0.0
                        Behavior on opacity { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                        Layout.fillWidth: true
                        ...
                        RowLayout {
                            anchors.centerIn: parent; spacing: Style.marginS
                            NIcon { icon: "loader"; color: Color.mOnSurface; Layout.alignment: Qt.AlignVCenter
                            ...
                            NText {
                                ...
                                color: Color.mOnSurface; pointSize: Style.fontSizeS; Layout.alignment: Qt.AlignVCenter
                            }
                        }
                    }
                    ...
                    // Recorder Done View
                    ColumnLayout {
                        property bool _shown: root.viewedTool === "record" && root.isDone && !root.isRunning
                        visible: _shown
                        opacity: _shown ? 1.0 : 0.0
                        Behavior on opacity { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    anchors.centerIn: parent; spacing: Style.marginS
                                    NIcon { icon: "device-floppy"; color: recSaveBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface }
                                    NText {
                            ...
                            Rectangle {
                                width: 38 * Style.uiScaleRatio; height: 38 * Style.uiScaleRatio; radius: Style.radiusM
                    ...
                    RowLayout {
                        ...
                        Layout.fillWidth: true; spacing: Style.marginS
                        Rectangle {
                            Layout.fillWidth: true; Layout.preferredHeight: 38 * Style.uiScaleRatio; radius: Style.radiusM
                            ...
                            RowLayout { anchors.centerIn: parent; spacing: Style.marginXS
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            NText { id: langLabel; text: pluginApi?.tr("panel.lang"); color: Color.mOnSurface; pointSize: Style.fontSizeS; Layout.alignment: Qt.AlignVCenter }
                            Flow {
                                visible: root.installedLangs.length <= 4
                                Layout.fillWidth: true
                                spacing: Style.marginXS; Layout.alignment: Qt.AlignVCenter
                                Repeater {
                            ...
                            Rectangle {
                                ...
                                border.color: Color.mPrimary; border.width: Style.capsuleBorderWidth
                                Layout.alignment: Qt.AlignVCenter
                                RowLayout { id: _scanRow; anchors.centerIn: parent; spacing: Style.marginXS
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            NText { text: pluginApi?.tr("mirror.title"); color: Color.mOnSurface; font.weight: Font.Bold; pointSize: Style.fontSizeS }
                        }
                        NText { Layout.fillWidth: true; wrapMode: Text.WordWrap; text: pluginApi?.tr("mirror.hint"); color: Color.mOnSurfaceVariant; pointSize: Style.fontSizeXS }
                        Rectangle {
                            Layout.fillWidth: true; Layout.preferredHeight: 38 * Style.uiScaleRatio; radius: Style.radiusM
                    ...
                    // Result Views
                    ResultColor {
                        property bool _shown: root.viewedTool === "colorpicker" && !root.isRunning
                        visible: _shown
                        opacity: _shown ? 1.0 : 0.0
                        Behavior on opacity { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                        Layout.fillWidth: true
                    ...
                    ResultOcr {
                        property bool _shown: root.viewedTool === "ocr" && (mainInstance?.ocrResult ?? "") !== "" && !root.isRunning
                        visible: _shown
                        opacity: _shown ? 1.0 : 0.0
                        Behavior on opacity { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                        Layout.fillWidth: true
                    ...
                    ResultQr {
                        property bool _shown: root.viewedTool === "qr" && (mainInstance?.qrResult ?? "") !== "" && !root.isRunning
                        visible: _shown
                        opacity: _shown ? 1.0 : 0.0
                        Behavior on opacity { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                        Layout.fillWidth: true
                    ...
                    ResultPalette {
                        property bool _shown: root.viewedTool === "palette" && !root.isRunning
                        visible: _shown
                        opacity: _shown ? 1.0 : 0.0
                        Behavior on opacity { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                        Layout.fillWidth: true
